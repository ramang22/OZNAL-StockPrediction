...
Odstranenie moznych chybnych symbolov a vytvorenie noveho stlpca pre kategorie.
...
Normalizovanie dat pomocou logaritmu. 

* customLogTransformZero = log(x+1)

* customLogTransformNegative = log(x+min(x)+1)

* customLogTransform = log(x)
...
Rozdelenie datasetu prebehlo len pomocou rozdelenia na test-train splitu kde random 75% dat je v train a 25% v test.
